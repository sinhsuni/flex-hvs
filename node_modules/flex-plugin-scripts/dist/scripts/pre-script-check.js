...
var _comparePluginAndCLIVersions = function () {
    ...
    var pluginVersion = flex_dev_utils_1.semver.coerce(fs_2.packageDependencyVersion(pluginPackageJson, 'flex-plugin-scripts'));
    if (cliVersion && pluginVersion && cliVersion.version !== pluginVersion.version) {
        var earlierVersion = cliVersion.version < pluginVersion.version ? 'CLI' : 'flex-plugin-scripts';
