    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                UISupports = flex_dev_utils_1.semver.satisfies('1.19.0', uiVersion) || flex_dev_utils_1.versionSatisfiesRange(uiVersion, '>=1.19.0') || defaultReactSupported;
                if (!UISupports) {
                    throw new flex_dev_utils_1.FlexPluginError(strings_1.singleLineString("We detected that your account is using Flex UI version " + uiVersion + " which is incompatible", "with unbundled React. Please visit https://flex.twilio.com/admin/versioning and update to", "version 1.19 or above."));
                }
